...
class InputFieldConstants {
  // text sizes
  static const double hintFontSize = 15.3;

  // icon sizes
  static const double hintIconSize = 20;

  // spacing
  static const double hintSpacing = 5;
  static const double contentPaddingBottom = 4.5;
  static const double addTodoIconSpaceRight = 7.5;
